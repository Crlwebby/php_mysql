...
<?php
  ...
  if (!isset($_GET['file'])) 
  {
     ...
     echo 'File Last Accessed: '.date('j F Y H:i', fileatime($safe_file)).'<br/>';//file access time
     echo 'File Last Modified: '.date('j F Y H:i', filemtime($safe_file)).'<br/>';//file modify time
